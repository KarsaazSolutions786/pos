...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("GLTD" == $this->chrt_array['tables'][0])
			return true;
		if("GltH" == $this->chrt_array['tables'][0])
			return true;
		if("pAccounts" == $this->chrt_array['tables'][0])
			return true;
		if("pCustomer" == $this->chrt_array['tables'][0])
			return true;
		if("pEmployee" == $this->chrt_array['tables'][0])
			return true;
		if("pProductItems" == $this->chrt_array['tables'][0])
			return true;
		if("pSupplier" == $this->chrt_array['tables'][0])
			return true;
		if("psAccountSubGroup" == $this->chrt_array['tables'][0])
			return true;
		if("psChartofAccounts" == $this->chrt_array['tables'][0])
			return true;
		if("psCustomerGroup" == $this->chrt_array['tables'][0])
			return true;
		if("psEmployeeGroup" == $this->chrt_array['tables'][0])
			return true;
		if("psProductGroup" == $this->chrt_array['tables'][0])
			return true;
		if("psSupplierGroup" == $this->chrt_array['tables'][0])
			return true;
		if("psUnits" == $this->chrt_array['tables'][0])
			return true;
		if("psUserGroup" == $this->chrt_array['tables'][0])
			return true;
		if("umUserInfo" == $this->chrt_array['tables'][0])
			return true;
		if("tSaleH" == $this->chrt_array['tables'][0])
			return true;
		if("tSaleD" == $this->chrt_array['tables'][0])
			return true;
		if("karsaaz_posugrights" == $this->chrt_array['tables'][0])
			return true;
		if("karsaaz_posugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("umUserInfo" == $this->chrt_array['tables'][0])
			return true;
		if("karsaaz_posugrights" == $this->chrt_array['tables'][0])
		...
		if("karsaaz_posugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("karsaaz_posuggroups" == $this->chrt_array['tables'][0])
			return true;
		if("pBU" == $this->chrt_array['tables'][0])
			return true;
		if("AccountCBal" == $this->chrt_array['tables'][0])
			return true;
		if("pBank" == $this->chrt_array['tables'][0])
			return true;
		if("psBankGroup" == $this->chrt_array['tables'][0])
			return true;
		if("sClosingMonth" == $this->chrt_array['tables'][0])
			return true;
		if("comission_group" == $this->chrt_array['tables'][0])
			return true;
		if("comission_group_detail" == $this->chrt_array['tables'][0])
			return true;
		if("label_codes" == $this->chrt_array['tables'][0])
			return true;
		if("label_groups" == $this->chrt_array['tables'][0])
			return true;
		if("language_lael" == $this->chrt_array['tables'][0])
			return true;
		if("languages" == $this->chrt_array['tables'][0])
			return true;
		if("selected_lanugage" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
