...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("umUserInfo", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "GLTD" ] = array( "url" => "gltd", "type" => 0 );
	$projectEntitiesReverse[ "gltd" ] = "GLTD";
	$projectEntities[ "GltH" ] = array( "url" => "glth", "type" => 0 );
	$projectEntitiesReverse[ "glth" ] = "GltH";
	$projectEntities[ "pAccounts" ] = array( "url" => "paccounts", "type" => 0 );
	$projectEntitiesReverse[ "paccounts" ] = "pAccounts";
	$projectEntities[ "pCustomer" ] = array( "url" => "pcustomer", "type" => 0 );
	$projectEntitiesReverse[ "pcustomer" ] = "pCustomer";
	$projectEntities[ "pEmployee" ] = array( "url" => "pemployee", "type" => 0 );
	$projectEntitiesReverse[ "pemployee" ] = "pEmployee";
	$projectEntities[ "pProductItems" ] = array( "url" => "pproductitems", "type" => 0 );
	$projectEntitiesReverse[ "pproductitems" ] = "pProductItems";
	$projectEntities[ "pSupplier" ] = array( "url" => "psupplier", "type" => 0 );
	$projectEntitiesReverse[ "psupplier" ] = "pSupplier";
	$projectEntities[ "psAccountSubGroup" ] = array( "url" => "psaccountsubgroup", "type" => 0 );
	$projectEntitiesReverse[ "psaccountsubgroup" ] = "psAccountSubGroup";
	$projectEntities[ "psChartofAccounts" ] = array( "url" => "pschartofaccounts", "type" => 0 );
	$projectEntitiesReverse[ "pschartofaccounts" ] = "psChartofAccounts";
	$projectEntities[ "psCustomerGroup" ] = array( "url" => "pscustomergroup", "type" => 0 );
	$projectEntitiesReverse[ "pscustomergroup" ] = "psCustomerGroup";
	$projectEntities[ "psEmployeeGroup" ] = array( "url" => "psemployeegroup", "type" => 0 );
	$projectEntitiesReverse[ "psemployeegroup" ] = "psEmployeeGroup";
	$projectEntities[ "psProductGroup" ] = array( "url" => "psproductgroup", "type" => 0 );
	$projectEntitiesReverse[ "psproductgroup" ] = "psProductGroup";
	$projectEntities[ "psSupplierGroup" ] = array( "url" => "pssuppliergroup", "type" => 0 );
	$projectEntitiesReverse[ "pssuppliergroup" ] = "psSupplierGroup";
	$projectEntities[ "psUnits" ] = array( "url" => "psunits", "type" => 0 );
	$projectEntitiesReverse[ "psunits" ] = "psUnits";
	$projectEntities[ "psUserGroup" ] = array( "url" => "psusergroup", "type" => 0 );
	$projectEntitiesReverse[ "psusergroup" ] = "psUserGroup";
	$projectEntities[ "umUserInfo" ] = array( "url" => "umuserinfo", "type" => 0 );
	$projectEntitiesReverse[ "umuserinfo" ] = "umUserInfo";
	$projectEntities[ "tSaleH" ] = array( "url" => "tsaleh", "type" => 0 );
	$projectEntitiesReverse[ "tsaleh" ] = "tSaleH";
	$projectEntities[ "tSaleD" ] = array( "url" => "tsaled", "type" => 0 );
	$projectEntitiesReverse[ "tsaled" ] = "tSaleD";
	...
	$projectEntities[ "karsaaz_posugrights" ] = array( "url" => "karsaaz_posugrights", "type" => 0 );
	$projectEntitiesReverse[ "karsaaz_posugrights" ] = "karsaaz_posugrights";
	$projectEntities[ "karsaaz_posugmembers" ] = array( "url" => "karsaaz_posugmembers", "type" => 0 );
	$projectEntitiesReverse[ "karsaaz_posugmembers" ] = "karsaaz_posugmembers";
	$projectEntities[ "karsaaz_posuggroups" ] = array( "url" => "karsaaz_posuggroups", "type" => 0 );
	$projectEntitiesReverse[ "karsaaz_posuggroups" ] = "karsaaz_posuggroups";
	$projectEntities[ "pBU" ] = array( "url" => "pbu", "type" => 0 );
	$projectEntitiesReverse[ "pbu" ] = "pBU";
	$projectEntities[ "AccountCBal" ] = array( "url" => "accountcbal", "type" => 0 );
	$projectEntitiesReverse[ "accountcbal" ] = "AccountCBal";
	$projectEntities[ "pBank" ] = array( "url" => "pbank", "type" => 0 );
	$projectEntitiesReverse[ "pbank" ] = "pBank";
	$projectEntities[ "psBankGroup" ] = array( "url" => "psbankgroup", "type" => 0 );
	$projectEntitiesReverse[ "psbankgroup" ] = "psBankGroup";
	$projectEntities[ "sClosingMonth" ] = array( "url" => "sclosingmonth", "type" => 0 );
	$projectEntitiesReverse[ "sclosingmonth" ] = "sClosingMonth";
	$projectEntities[ "comission_group" ] = array( "url" => "comission_group", "type" => 0 );
	$projectEntitiesReverse[ "comission_group" ] = "comission_group";
	$projectEntities[ "comission_group_detail" ] = array( "url" => "comission_group_detail", "type" => 0 );
	$projectEntitiesReverse[ "comission_group_detail" ] = "comission_group_detail";
	$projectEntities[ "label_codes" ] = array( "url" => "label_codes", "type" => 0 );
	$projectEntitiesReverse[ "label_codes" ] = "label_codes";
	$projectEntities[ "label_groups" ] = array( "url" => "label_groups", "type" => 0 );
	$projectEntitiesReverse[ "label_groups" ] = "label_groups";
	$projectEntities[ "language_lael" ] = array( "url" => "language_lael", "type" => 0 );
	$projectEntitiesReverse[ "language_lael" ] = "language_lael";
	$projectEntities[ "languages" ] = array( "url" => "languages", "type" => 0 );
	$projectEntitiesReverse[ "languages" ] = "languages";
	$projectEntities[ "selected_lanugage" ] = array( "url" => "selected_lanugage", "type" => 0 );
	$projectEntitiesReverse[ "selected_lanugage" ] = "selected_lanugage";
}
