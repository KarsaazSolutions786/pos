...
require_once("include/customers_product_price_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "customers_product_price" );
