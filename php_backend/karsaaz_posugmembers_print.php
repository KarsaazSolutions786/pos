...
require_once("include/karsaaz_posugmembers_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "karsaaz_posugmembers" );
