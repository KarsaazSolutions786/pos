...
$nonAdminTablesArr[] = "GLTD";
$nonAdminTablesArr[] = "GltH";
$nonAdminTablesArr[] = "pAccounts";
$nonAdminTablesArr[] = "pCustomer";
$nonAdminTablesArr[] = "pEmployee";
$nonAdminTablesArr[] = "pProductItems";
$nonAdminTablesArr[] = "pSupplier";
$nonAdminTablesArr[] = "psAccountSubGroup";
$nonAdminTablesArr[] = "psChartofAccounts";
$nonAdminTablesArr[] = "psCustomerGroup";
$nonAdminTablesArr[] = "psEmployeeGroup";
$nonAdminTablesArr[] = "psProductGroup";
$nonAdminTablesArr[] = "psSupplierGroup";
$nonAdminTablesArr[] = "psUnits";
$nonAdminTablesArr[] = "psUserGroup";
$nonAdminTablesArr[] = "umUserInfo";
$nonAdminTablesArr[] = "tSaleH";
$nonAdminTablesArr[] = "tSaleD";
$nonAdminTablesArr[] = "karsaaz_posugrights";
$nonAdminTablesArr[] = "karsaaz_posugmembers";
$nonAdminTablesArr[] = "karsaaz_posuggroups";
$nonAdminTablesArr[] = "pBU";
$nonAdminTablesArr[] = "AccountCBal";
$nonAdminTablesArr[] = "pBank";
$nonAdminTablesArr[] = "psBankGroup";
$nonAdminTablesArr[] = "sClosingMonth";
$nonAdminTablesArr[] = "comission_group";
$nonAdminTablesArr[] = "comission_group_detail";
$nonAdminTablesArr[] = "label_codes";
$nonAdminTablesArr[] = "label_groups";
$nonAdminTablesArr[] = "language_lael";
$nonAdminTablesArr[] = "languages";
$nonAdminTablesArr[] = "selected_lanugage";
...
$wGroupTableName = $ug_connection->addTableWrappers( "karsaaz_pos1uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "karsaaz_pos1ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "karsaaz_pos1ugrights" );
