...
require_once("include/karsaaz_posuggroups_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "karsaaz_posuggroups" );
