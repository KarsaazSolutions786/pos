...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "karsaaz_pos_at_localhost";
		$data["connName"] = "karsaaz_pos at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;3309;karsaaz_pos;;1"; //currently unused

		$this->_connectionsIdByName["karsaaz_pos at localhost"] = "karsaaz_pos_at_localhost";
		...
		$data["connInfo"][0] = getenv('DB_HOST') ?: "localhost";
		$data["connInfo"][1] = getenv('DB_USERNAME') ?: "root";
		$data["connInfo"][2] = getenv('DB_PASSWORD') ?: "";
		$data["connInfo"][3] = getenv('DB_PORT') ?: "3309";
		$data["connInfo"][4] = "karsaaz_pos";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Port=3309;Database=karsaaz_pos;OPTION=3";
		// encription set
		...
		$connectionsData["karsaaz_pos_at_localhost"] = $data;
