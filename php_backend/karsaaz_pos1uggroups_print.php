...
require_once("include/karsaaz_pos1uggroups_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "karsaaz_pos1uggroups" );
