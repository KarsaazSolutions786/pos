...
function GetDefaultValue($field, $ptype, $table="")
{
	...
	if(!$table)
		$table=$strTableName;
				if($table=="pAccounts" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="pAccounts" && $field=="UnitCode")
	{
		return 1;
	}
				if($table=="pCustomer" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="pCustomer" && $field=="GroupCode")
	{
		return 1;
	}
				if($table=="pCustomer" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="pCustomer" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="pCustomer" && $field=="Block")
	{
		return 0;
	}
				if($table=="pEmployee" && $field=="BUnit")
	{
		return 0;
	}
				if($table=="pEmployee" && $field=="EmployeeGroup")
	{
		return 1;
	}
				if($table=="pEmployee" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="pEmployee" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="pEmployee" && $field=="Block")
	{
		return 0;
	}
				if($table=="pProductItems" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="pProductItems" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="pProductItems" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="pProductItems" && $field=="Block")
	{
		return 0;
	}
				if($table=="pSupplier" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="pSupplier" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="pSupplier" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="pSupplier" && $field=="Block")
	{
		return 0;
	}
				if($table=="psAccountSubGroup" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="psAccountSubGroup" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="psAccountSubGroup" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psAccountSubGroup" && $field=="Block")
	{
		return 0;
	}
				if($table=="psAccountSubGroup" && $field=="Lock")
	{
		return 0;
	}
				if($table=="psAccountSubGroup" && $field=="Hide")
	{
		return 0;
	}
				if($table=="psChartofAccounts" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="psChartofAccounts" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="psChartofAccounts" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psChartofAccounts" && $field=="Block")
	{
		return 0;
	}
				if($table=="psCustomerGroup" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="psCustomerGroup" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="psCustomerGroup" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psCustomerGroup" && $field=="Block")
	{
		return 0;
	}
				if($table=="psEmployeeGroup" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="psEmployeeGroup" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="psEmployeeGroup" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psEmployeeGroup" && $field=="Block")
	{
		return 0;
	}
				if($table=="psProductGroup" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="psProductGroup" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="psProductGroup" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psProductGroup" && $field=="Block")
	{
		return 0;
	}
				if($table=="psProductGroup" && $field=="Lock")
	{
		return 0;
	}
				if($table=="psProductGroup" && $field=="Hide")
	{
		return 0;
	}
				if($table=="psProductGroup" && $field=="Bookmark")
	{
		return 0;
	}
				if($table=="psSupplierGroup" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="psSupplierGroup" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psSupplierGroup" && $field=="Block")
	{
		return 0;
	}
				if($table=="psUnits" && $field=="BUnit")
	{
		return 0;
	}
				if($table=="psUnits" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="psUnits" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psUnits" && $field=="Block")
	{
		return 0;
	}
				if($table=="psUserGroup" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="psUserGroup" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="psUserGroup" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="psUserGroup" && $field=="Block")
	{
		return 0;
	}
				if($table=="tSaleH" && $field=="BookCode")
	{
		return 3;
	}
				if($table=="tSaleH" && $field=="BookID")
	{
		return 3;
	}
				if($table=="tSaleH" && $field=="TBook")
	{
		return POS;
	}
				if($table=="tSaleH" && $field=="TDate")
	{
		return now();
	}
				if($table=="tSaleH" && $field=="BUnit")
	{
		return 1;
	}
				if($table=="tSaleH" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="tSaleH" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="tSaleH" && $field=="Block")
	{
		return 0;
	}
				if($table=="tSaleD" && $field=="Tdate")
	{
		return now();
	}
				if($table=="tSaleD" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="tSaleD" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="tSaleD" && $field=="Block")
	{
		return 0;
	}
				if($table=="tSaleD" && $field=="BuCode")
	{
		return 1;
	}
				if($table=="pBU" && $field=="CreateDate")
	{
		return now();
	}
				if($table=="pBU" && $field=="UpdateDate")
	{
		return now();
	}
				if($table=="pBU" && $field=="Block")
	{
		return 0;
	}
				if($table=="pBU" && $field=="Lock")
	{
		return 0;
	}
				if($table=="pBU" && $field=="Hide")
	{
		return 0;
	}
	return "";
