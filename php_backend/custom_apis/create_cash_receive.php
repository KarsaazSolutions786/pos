...
try {
    // Step 1: Insert master without Code to get masterId
		...
		$currentYear = date('y');
		$currentdatetime = now();
		$last_sales_query = DB::query("SELECT * FROM GLTH WHERE (TType = 'Cash Receive') ORDER BY Code DESC LIMIT 1");
    ...
    $gltHData["TBook"] = "Cash Receive";
    $gltHData["TType"] = "Cash Receive";
    ...
    foreach ($details as $entry) {
        ...
        $gltd["BUnit"] = 1;
        $gltd["TBook"] = "Cash Receive";
        $gltd["TType"] = "Cash Receive";
