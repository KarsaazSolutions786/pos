...
export default function Journal() {
  ...
  console.log("🚀 ~ Journal ~ formData:", formData.debitAccount)
...
// }, [accountsList, formData.debitAccount]);
  ...
  const checkBillNumberExists = async (billNumber: string) => {
    ...
    try {
      ...
      const response = await fetch("/custom_apis/jv_list.php", {
        method: "POST",
...
const handleSave = async () => {
  ...
  const payload = {
  api_key: user?.apiKey || "123",
  master: { Amount: parseFloat(formData.Amount) },
  details: [
    {
    ...
    const res = await fetch("/custom_apis/create_jv.php", {
      method: "POST",
      headers: {
    ...
    if (!res.ok || !result.success) {
      throw new Error(result.message || "Failed to create Journal Voucher");
    }

    alert("Journal Voucher created successfully! Virtual Code: " + (result.virtual_code || "N/A"));
    setLoading(false);
          ...
          <header className="bg-white shadow-sm border-b border-gray-200">
            <div className="flex justify-between items-center px-6 py-4">
              <div className="flex items-center">
                <h1 className="text-2xl font-bold text-gray-900">{t("nav_dashboard", "Dashboard")}</h1>
              </div>
              <div className="flex items-center space-x-4">
                <div className="flex items-center space-x-3">
                  <span className="text-sm text-gray-700">
                    {t("label_welcome", "Welcome")}, {user?.name}
                  </span>
                  <span
            ...
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-pink-50 p-4">
              <div className="bg-white rounded-2xl shadow-lg p-6 max-w-5xl w-full">
                <h1 className="text-2xl font-bold text-center mb-1 text-blue-900">
                  {t("page_title_jv_entry", "Journal Voucher Entry")}
                </h1>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h2 className="flex items-center text-lg font-semibold mb-4 text-green-700">
                      ...
                      {t("section_basic_information", "Basic Information")}
                    </h2>
                ...
                {showError("voucherNumber")}
                      ...
                      <div>
                        ...
                        {billNumberExists && (
                          <p className="text-red-500 text-xs flex items-center mt-2">
                            <ExclamationCircleIcon className="w-4 h-4 mr-1" />
                            {t("error_bill_number_exists", "This Bill Number already exists!")}
                          </p>
                        )}
                    ...
                    <option key={type} value={type}>
                      ...
                      <div>
                        ...
                        <SearchableDropdown
                          ...
                          placeholder={t("placeholder_select_group", "Select Group")}
                          searchPlaceholder={t("placeholder_search_debit_account", "Search Debit Account...")}
                          required
                      ...
                      <div>
                        ...
                        <SearchableDropdown
                          ...
                          placeholder={t("placeholder_select_group", "Select Group")}
                          searchPlaceholder={t("placeholder_search_credit_account", "Search Credit Account...")}
                          required
                          className="w-full  text-sm"
                           preventAutoSelect={true} 
                        />
                ...
                <div className="flex justify-center space-x-4 mt-10">
                  ...
                  >
                    {loading ? t("btn_saving", "Saving...") : t("btn_save_entry", "Save Entry")}
                  </button>
